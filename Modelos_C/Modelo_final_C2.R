...
dataprep.out <-
  dataprep(foo = total,
           predictors = c("RUC_total", "GDP_pc", "GDP", "rural", "maternal", "vuln", "neonatal"),
           predictors.op = "mean",
           dependent = "sui_rate",
           unit.variable = "id",
           time.variable = "year",
...
library(writexl)
write_xlsx(gaps_f,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/gapsC2.xlsx")
write_xlsx(errorV,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/errorC2.xlsx")

actual <- as.data.frame(actual)
predicted <- as.data.frame(predicted)
write_xlsx(actual,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/actualsC2.xlsx")
write_xlsx(predicted,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/predsC2.xlsx")
