...
dataprep.out <-
  dataprep(foo = total,
           predictors = c("RUC_total", "GDP_pc", "GDP", "life_exp", "christianity_all",
                          "noreligion_all", "rural", "infla", "under5", "alcohol"),
           predictors.op = "mean",
           dependent = "sui_rate",
           unit.variable = "id",
           time.variable = "year",
...
library(writexl)
write_xlsx(gaps_f,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/gapsC1.xlsx")
write_xlsx(errorV,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/errorC1.xlsx")

actual <- as.data.frame(actual)
predicted <- as.data.frame(predicted)
write_xlsx(actual,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/actualsC1.xlsx")
write_xlsx(predicted,"C:/Users/Karen/Desktop/Tesis_Maestría/Modelos_C/predsC1.xlsx")
